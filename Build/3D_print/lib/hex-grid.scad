...
////////////////////////////////////////////////////////////////////
// grid: takes five parameters and returns the initial grid of 
//    hexagons
//
...
//      hexagon
//    x_offset: scalar value specifying the offset in the x direction
//    y_offset: scalar value specifying the offset in the y direction
////////////////////////////////////////////////////////////////////
module grid(size, cell_hole, cell_wall, x_offset, y_offset) {
...
//   y_offset: scalar value specifying the offset in the y direction
////////////////////////////////////////////////////////////////////
module create_grid(size, SW, wall, x_offset=0, y_offset=0, ext_walls=0) {
  b = 2*wall;
  ...
  if(ext_walls==0){
    ...
    difference() {
      grid(size=size, cell_hole=SW, cell_wall=wall, x_offset=x_offset,   y_offset=y_offset);
      mask(size);
    }
  }
  else{
    translate([0,0,-ext_walls/2])square3D(size[0],size[1],size[2],ext_walls);
    x_offset=ext_walls/2;
    difference() {
      grid(size=size, cell_hole=SW, cell_wall=wall, x_offset=x_offset, y_offset=y_offset);
      mask(size);
    }
...
////////////////////////////////////////////////////////////////////
//create_grid(size=[100,150,10], SW=20, wall=4, x_offset=10, y_offset=10);
